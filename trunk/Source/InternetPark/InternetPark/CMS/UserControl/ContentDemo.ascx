<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContentDemo.ascx.cs"
    Inherits="InternetPark.CMS.UserControl.ContentDemo" %>
<!-- content -->
<!-- content / right -->
<div id="right">
    <!-- table -->
    ...
    <div class="box">
        ...
        <div class="sales">
            <div class="legend">
                <h6>
                    Units Sold (April 1st to April 15th)</h6>
                <ul>
     ...
     <div id="box-tabs" class="box">
       ...
       <div id="box-messages">
        ...
        <div id="box-other">
            <!-- paragraphs -->
            <p class="start">
                <img src="resources/images/misc/ginger.jpg" alt="Ginger" class="right" />Lorem ipsum
                dolor sit amet, consectetur <a href="">adipisicing</a> elit, sed do eiusmod tempor
            ...
            <p>
                ...
                sunt in culpa qui officia deserunt mollit anim id est laborum. Duis aute irure dolor
        ...
        <div id="box-dialogs">
            <p>
                <a id="dialog-open" href="#">Open Dialog</a></p>
            <p>
                <a id="dialog-modal-open" href="#">Open Modal Dialog</a></p>
            <p>
                <a id="dialog-message-open" href="#">Open Modal Message Dialog</a></p>
            <p>
                <a id="dialog-confirm-open" href="#">Open Modal Confirmation Dialog</a></p>
            <p>
                <a id="dialog-form-open" href="#">Open Form Dialog</a></p>
        </div>
    </div>
    <!-- end messages -->
    <!-- forms -->
        ...
        <div class="form">
            <div class="fields">
                ...
                <div class="field">
                    ...
                    <div class="input">
                        <input type="text" id="autocomplete" name="input.autocomplete" value="start typing for example: java"
                            class="small focus" />
                    </div>
                </div>
                <div class="field">
