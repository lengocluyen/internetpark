...
<div class="banner_container">
    ...
    <div style="float: left; width: 100%">
        <div class="menu">
            <ul>
                <li><a href="?<%=InternetPark.Core._No_Change_Query.menu%>=1">
                    <img src="Images/menu1.png" border="0" /></a></li>
                <li><a href="http://it.dlu.edu.vn" target="_blank">
                    <img src="Images/menu2.png" border="0" /></a></li>
                <li><a href="http://it.dlu.edu.vn" target="_blank">
                    <img src="Images/menu3.png" border="0" /></a></li>
            </ul>
        </div>
        <div class="search">
